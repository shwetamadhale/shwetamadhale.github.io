...
3. **SSW 564 (Software Requirements Analysis and Engineering)** - A(4.0)
...
4. **SSW 555 (Agile Methods for Software Development)** - A(4.0)
...
5. **CS 559 (Machine Learning)** - A-(3.67)
...
6. **CS 584 (Natural Language Processing)** - A(4.0)
...
7. **CS 541 (Artificial Intelligence)** - A(4.0)
...
8. **CS 556 (Mathematical Foundations of ML)** - B(3.0)
...
12. **CS 570 (Data Structures and Algorithms)** - A(4.0)
